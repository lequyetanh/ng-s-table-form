...
class NgSTableFormComponent {
    ...
    ngOnChanges() {
        ...
        if (this.itemSelected.change) {
            (_a = this.keyword$) === null || _a === void 0 ? void 0 : _a.setValue(this.itemSelected.name, { emitEvent: false });
...
class CurrencyNumberDirective {
    ...
    onInput(event) {
        ...
        if (inputValue !== '0' &&
            (inputValue === null || inputValue === void 0 ? void 0 : inputValue.charCodeAt(0)) === 48 &&
            (inputValue === null || inputValue === void 0 ? void 0 : inputValue.charCodeAt(1)) !== (CurrencyNumberDirective.integerFormat == ',' ? 46 : 44)) {
